...
with open('../otrosArchivos/resultados_jm.pkl', 'rb') as f:
...
ax.set_title('Matriz de confusión — feats=[jm]', fontsize=13, pad=12)
...
plt.tight_layout()
plt.savefig('matriz_confusion_jm.png', dpi=150)
print('Guardado en matriz_confusion_jm.png')
