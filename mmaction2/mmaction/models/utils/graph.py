...
class Graph:
    ...
    def __init__(self,
        ...
        if isinstance(layout, dict):
            ...
            assert layout in ['openpose', 'nturgb+d', 'coco', 'taichi']
    ...
    def set_layout(self, layout: str) -> None:
        ...
        if layout == 'openpose':
            ...
            inward = [
                (1, 0),   # HEAD -> SPINEBASE
                (2, 8),   # SHOULDERLEFT -> HIPLEFT
                (5, 12),  # SHOULDERRIGHT -> HIPRIGHT
                (2, 5),   # SHOULDERLEFT -> SHOULDERRIGHT
                (3, 2),   # ELBOWLEFT -> SHOULDERLEFT
                (4, 3),   # WRISTLEFT -> ELBOWLEFT
                (16, 4),  # HANDTIPLEFT -> WRISTLEFT
                (17, 4),  # THUMBLEFT -> WRISTLEFT
                (6, 5),   # ELBOWRIGHT -> SHOULDERRIGHT
                (7, 6),   # WRISTRIGHT -> ELBOWRIGHT
                (18, 7),  # HANDTIPRIGHT -> WRISTRIGHT
                (19, 7),  # THUMBRIGHT -> WRISTRIGHT
                (8, 0),   # HIPLEFT -> SPINEBASE
                (12, 0),  # HIPRIGHT -> SPINEBASE
                (9, 8),   # KNEELEFT -> HIPLEFT
                (10, 9),  # ANKLELEFT -> KNEELEFT
                (11, 10), # FOOTLEFT -> ANKLELEFT
                (13, 12), # KNEERIGHT -> HIPRIGHT
                (14, 13), # ANKLERIGHT -> KNEERIGHT
                (15, 14), # FOOTRIGHT -> ANKLERIGHT
            ]
            self.num_node = num_node
            self.inward = inward
            self.center = 0  # spinebase como centro
